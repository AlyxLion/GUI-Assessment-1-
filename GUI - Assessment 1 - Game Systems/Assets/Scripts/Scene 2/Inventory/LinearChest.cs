...
public class LinearChest : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        if (showChest)
        {
            ...
            {
                if (GUI.Button(new Rect(MenuHandler.screen.x* 12.75f, MenuHandler.screen.y * 0.25f + i *(MenuHandler.screen.y * 0.25f), MenuHandler.screen.x * 3f, MenuHandler.screen.y * 0.25f),chestInv[i].Name))
                {
            ...
            {           
                if (GUI.Button(new Rect(MenuHandler.screen.x * 12.5f, MenuHandler.screen.y * 6.5f, MenuHandler.screen.x * 1.5f, MenuHandler.screen.y * 0.25f), "Take"))
                {
